    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <aside class="lg:w-64 flex-shrink-0">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                ...
                <nav class="p-3">
                    <a href="admin.jsp?tab=dashboard" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all mb-1 ${tab eq 'dashboard' ? "bg-primary text-white shadow-lg shadow-primary/30" : "text-gray-600 hover:bg-gray-50"}">
                    ...
                    <a href="admin.jsp?tab=users" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all mb-1 ${tab eq 'users' ? "bg-primary text-white shadow-lg shadow-primary/30" : "text-gray-600 hover:bg-gray-50"}">
                    ...
                    <a href="admin.jsp?tab=books" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${tab eq 'books' ? "bg-primary text-white shadow-lg shadow-primary/30" : "text-gray-600 hover:bg-gray-50"}">
                    ...
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg shadow-blue-500/30 transform hover:scale-105 transition-transform">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <h3 class="text-4xl font-bold">${users.size()}</h3>
                            </div>
                            <div class="w-12 h-12 bg-white/20 backdrop-blur rounded-xl flex items-center justify-center">
                    ...
                    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg shadow-green-500/30 transform hover:scale-105 transition-transform">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <h3 class="text-4xl font-bold">${books.size()}</h3>
                            </div>
                            <div class="w-12 h-12 bg-white/20 backdrop-blur rounded-xl flex items-center justify-center">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">전체 ${users.size()}명의 회원</p>
                        </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="text-sm font-semibold text-gray-900">${u.nickname}</div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500">${b.publisher}</div>
                                                </div>
                                            </div>
                                        </td>
